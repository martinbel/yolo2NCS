...
def _main(args):
    ...
    prev_layer = Input(shape=(image_height, image_width, 3), name='Input')
...
#            prev_layer = all_layers[-1]
            ...
            section.startswith('avgpool') or
            section.startswith('cost') or
        ...
        print('Layer:', all_layers[-1])

    # Create and save model.
    output_layer = all_layers[-1]
    model = Model(inputs=all_layers[0], outputs=output_layer)
    print(model.summary())
